class string_builder
{
	public static void main(String args[])
	{
		...
		// 1. append()-append the specified string to the builder
		sb.append(" Bangalore");
        ...
        System.out.println("After delete: " + sb);
		 ...
		 // 5. reverse() - Reverses the characters in the builder
        sb.reverse();
        ...
        // 7. capacity() - Returns the current capacity of the builder
		...
		// 11. ensureCapacity() - Ensures the minimum capacity of the builder
